			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="index.html" class="navbar-brand">
						<small>
				PT. Abdi kurnia Jaya | Admin Panel
						</small>
					</a>
				</div>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<marquee>&copy; 2022 -
							<span class="red bolder">PT.Abdi Kurnia Jaya </span>
						</span></marquee>
					</div>
				</div>
			</div>
...
Highcharts.chart('container', {
	...
	$month = date('m');
							...
							$con=mysqli_connect("localhost","root","","keuanganku");
				
							$sql   = "SELECT * FROM pendapatan where keterangan='Pendapatan'";
...
Highcharts.chart('cashout', {
	 chart: {
					type: 'column'
				 },   

    title: {
					text: 'Pengeluaran Perusahaan '
				 },
				 xAxis: {
					type: 'category',
			        labels: {
	...
	$month = date('m');
							...
							$sql   = "SELECT * FROM pendapatan where keterangan='Pengeluaran'";
							$query = mysqli_query( $con, $sql )  or die(mysqli_error());
							while( $temp = mysqli_fetch_array( $query ) )
							{
								$tanggal=$temp['tgl']; 
